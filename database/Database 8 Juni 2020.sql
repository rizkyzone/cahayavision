...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2020 at 03:28 PM
...
(19, '68657537686001', 'Renaldi', 'Jl Anggrek Cendrawasih 5 Bl J/56-A,Kemanggisan', 63, 'renaldi5', '10c248a4d6e01b5ebaef47ac64bd822593e194cc', '0891231232131'),
...
(26, 15, '2020-05-14', NULL, '', '', '', '', '3', '0', 'default.jpg'),
(31, 16, '2020-05-13', NULL, '', '', '', '', '3', '0', 'pembayaran-2020-05-28_17-01-49.jpg'),
(33, 46, '2020-06-08', NULL, '2', '1', '110000', '10000', '3', '2', 'pembayaran-2020-06-08_09-09-42.png'),
(37, 34, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(38, 30, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(39, 32, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(40, 25, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(41, 18, '2020-06-08', NULL, NULL, NULL, NULL, '', '3', '', 'default.jpg'),
(43, 33, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(44, 19, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(46, 15, '0000-00-00', NULL, NULL, NULL, NULL, '', '1', '', 'default.jpg'),
(51, 46, NULL, '2020-07-08', NULL, NULL, NULL, '', '1', '', 'default.jpg');
...
INSERT INTO `pemutusan` (`pemutusan_id`, `pelanggan_id`, `teknisi_id`, `alasan_pemutusan`, `tanggal_pemutusan`) VALUES
(2, 15, 3, 'berhenti', '2020-06-01'),
(3, 20, 2, 'tes', '2020-06-02');
...
(14, 47, 'Suara Delay', '2020-06-05', 3, '3'),
(15, 47, 'gambar hilang', '2020-06-05', 1, '3');
...
(1, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Muhammad Rizky', 'banjarmasin', '1'),
...
--
ALTER TABLE `pembayaran`
  MODIFY `pembayaran_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `pemutusan`
--
ALTER TABLE `pemutusan`
  MODIFY `pemutusan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `pengaduan`
--
ALTER TABLE `pengaduan`
  MODIFY `pengaduan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
