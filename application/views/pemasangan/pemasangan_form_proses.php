    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Process Data Pemasangan</h6>
            </div>
                 <div class="card-body">
                 <div class="my-2">
                   ...
                   <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl" value="<?=$this->input->post('tgl') ?? $row->tanggal_pemasangan?>" class="form-control <?= form_error('tgl') ? 'is-invalid' : null ?>">
                                <?= form_error('tgl') ?>
                            </div>
                            <div class="form-group">
                            <label class="control-label"><small>Jumlah TV : </small></label>
                            <select name="jumlah_id" id="jumlah_id" class="form-control show-tick <?= form_error('jumlah_id') ? 'is-invalid' : null ?>" >
                            ...
                            <?= form_error('jumlah_id') ?>
                            </div>
                            <div class="form-group">
                            <label class="control-label"><small>Nama Teknisi : </small></label>
                            <select name="teknisi_id" id="teknisi_id" class="form-control show-tick <?= form_error('teknisi_id') ? 'is-invalid' : null ?>" >
                            <option value="">- Pilih -</option>
