...
<head>
  ...
  <title>PT. Cahaya MU Vision - Login</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0 ">
            ...
            <div class="row">
              <img src="<?php echo base_url('assets/') ?>/img/logo-mu.png" class="col-lg-6 d-none d-lg-block">
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login Pelanggan</h1>
                  </div>
                  <form action="<?=site_url('auth/process_login')?>" method="post" class="user">
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" placeholder="Enter Username..." required autofocus>
                    </div>
                    <div class="form-group">
